Introduction :- This app is created using Python programming language. With this application, you can create a QR code for any word, letter, and number and you can save those QR codes.
